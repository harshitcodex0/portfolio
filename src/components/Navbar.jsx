        ...
        <>
            ...
            >
                    ...
                    <a
                        ...
                        className="text-xl md:text-2xl font-bold text-white tracking-tight hover:opacity-80 transition-opacity duration-200 shrink-0 no-underline"
                        style={{ color: "#e8f0fe", letterSpacing: "-0.5px" }}
                    >
                        HARSHIT<span style={{ color: "#60a5fa" }}>.</span>
                    </a>
                    ...
                    <button
                        ...
                        className="flex lg:hidden flex-col justify-center items-center gap-[5px] shrink-0"
                        style={{
                            width: 40,
                            height: 40,
            ...
            <aside
                ref={menuRef}
                className="lg:hidden fixed top-0 right-0 bottom-0 flex flex-col overflow-y-auto"
                style={{
                    zIndex: 210,
                    width: "min(320px, 85vw)",
                    background: "rgba(8, 10, 20, 0.88)",
                    backdropFilter: "blur(8px) url(#liquid-glass) saturate(200%)",
            ...
            >
                ...
                >
                    <span className="text-xl font-bold" style={{ color: "#e8f0fe", letterSpacing: "-0.5px" }}>
                        Harshit<span style={{ color: "#60a5fa" }}>.</span>
                    </span>
                    <button
                        onClick={() => setMenuOpen(false)}
                        ...
                        {navLinks.map(({ name, link }, i) => (
                            ...
                            >
                                <a
                                    href={link}
                                    onClick={(e) => handleNavClick(e, link, name)}
                                    className="flex items-center gap-4 px-4 py-4 rounded-xl no-underline font-medium text-base transition-colors duration-200"
                                    style={{
